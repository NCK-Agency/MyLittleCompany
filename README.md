...
My Little Company (MLC) is a conversational organizational-memory product for non-technical small-business owners. It captures useful knowledge from everyday conversations, asks a human to approve it, and makes the approved knowledge available to AI assistants and employees.
...
docs/DECISION_LOG.md       Architecture and product decisions
...
and deploy without adding AWS or sponsor credentials.
