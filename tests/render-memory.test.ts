...
describe("renderMemoryDocument", () => {
  it("is deterministic and includes provenance", () => {
    const memory = {
      record: { id: "m1", companyId: "c1", type: "DECISION", status: "APPROVED", currentVersion: 1, title: "Discount limit", scope: { level: "COMPANY" }, appliesToRoles: ["MARKETING"], sensitivity: "INTERNAL", tags: [], effectiveFrom: "2026-07-11T00:00:00.000Z", createdAt: "2026-07-11T00:00:00.000Z", updatedAt: "2026-07-11T00:00:00.000Z", indexStatus: "READY" },
      version: { memoryId: "m1", companyId: "c1", version: 1, title: "Discount limit", scope: { level: "COMPANY" }, statement: "Never exceed 15%.", rationale: "Protect margins.", appliesToRoles: ["MARKETING"], sensitivity: "INTERNAL", tags: [], effectiveFrom: "2026-07-11T00:00:00.000Z", sourceRefs: [{ sourceId: "s1", label: "Owner conversation" }], approvedBy: "owner", approvedAt: "2026-07-11T00:00:00.000Z", createdAt: "2026-07-11T00:00:00.000Z" },
